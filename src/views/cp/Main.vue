        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
            <a href="#" class="dropdown-item">
              <i class="fas fa-envelope mr-2"></i> 個人資料
            </a>
            <div class="dropdown-divider"></div>
            <a href="#" class="dropdown-item">
              <i class="fas fa-users mr-2"></i> 修改密碼
            </a>
            <div class="dropdown-divider"></div>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="#" class="brand-link">
        <img
          ...
          style="opacity: 0.8"
        />
        <span class="brand-text font-weight-light">後台管理</span>
      </a>
          ...
          >
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <router-link to="/cp/products" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>產品列表</p>
                  </router-link>
                </li>
                <li class="nav-item">
                  <router-link to="/cp/cats" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>產品分類</p>
                  </router-link>
                </li>
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        ...
        <div class="card">
          ...
          <!-- /.card-body -->
          <div class="card-footer d-none">Footer</div>
          <!-- /.card-footer-->
        </div>
        <!-- /.card -->
      </section>
