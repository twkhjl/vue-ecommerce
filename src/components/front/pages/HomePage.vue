        ...
        <ul>
          ...
          >
            ...
            <div
              ...
              "
            >
              Lurking in the deep of the sea, waits a monster.
            </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="category-box">
            <a href="">
              <img
                src="/assets_front/images/shop/category/category-1.jpg"
                alt=""
              />
              <div class="content">
                <h3>Clothes Sales</h3>
          ...
          <div class="category-box">
            <a href="">
              <img
                src="/assets_front/images/shop/category/category-2.jpg"
                alt=""
              />
              <div class="content">
                <h3>Smart Casuals</h3>
        ...
        <div class="col-md-6">
          <div class="category-box category-box-2">
            <a href="">
              <img
                src="/assets_front/images/shop/category/category-3.jpg"
                alt=""
              />
              <div class="content">
                <h3>Jewellery</h3>
                  ...
                  <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="product-short-details">
                      ...
                      <p class="product-short-description">
                        ...
                        elit. Rem iusto nihil cum. Illo laborum numquam rem aut
                        officia dicta cumque.
                      </p>
